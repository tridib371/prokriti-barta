        ...
        <>
          ...
          >
            ...
            <div className="flex-1 overflow-y-auto p-4 sm:p-5 space-y-4 z-10">
              {cart.length === 0 ? (
                /* Enhanced Gorgeous Clean Empty State */
                <div className="flex flex-col items-center justify-center h-full min-h-[380px] py-10 space-y-6 text-center my-auto">
                  ...
                  <motion.div
                    ...
                    className="relative"
                  >
                    <div className="w-24 h-24 bg-primary/10 text-primary rounded-full flex items-center justify-center mx-auto shadow-inner border border-primary/20">
                      <ShoppingBag size={42} />
                    </div>
                    <div className="absolute -top-1 -right-1 w-7 h-7 bg-primary rounded-full text-white text-xs font-bold flex items-center justify-center shadow-md">
                      0
                    </div>
                  </motion.div>

                  <div className="space-y-2 max-w-xs">
                    <span className="px-3.5 py-1 bg-primary/10 text-primary font-bold text-xs rounded-full inline-block border border-primary/20 leading-none">
                      {lang === 'bn' ? 'কার্ট সম্পূর্ণ খালি' : 'Cart is Empty'}
                    </span>
                    <h3 className="font-display font-bold text-xl sm:text-2xl text-primary">{t('cartdrawer.empty.title')}</h3>
                  ...
                  <Button
                    ...
                    className="rounded-full px-8 py-3 font-bold shadow-md hover:scale-105 active:scale-95 transition-all gap-2"
                  >
                  ...
                  {/* Trust Strip */}
                  <div className="w-full pt-6 border-t border-line/60 grid grid-cols-2 gap-3 text-[11px] text-muted font-bn-sans text-left">
                    <div className="flex items-center gap-1.5 bg-bg/60 p-2.5 rounded-xl border border-line/50">
