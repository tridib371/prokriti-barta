...
export default function Button({
  ...
  const variants = {
    ...
    accent: "bg-accent text-white hover:bg-accent/90 font-semibold active:scale-[0.98] shadow-sm hover:shadow",
    ...
    danger: "bg-accent-2 text-white hover:bg-accent-2/90 active:scale-[0.98]"
  };

  const sizes = {
    sm: "px-3 py-1.5 text-xs gap-1.5",
    md: "px-4 py-2 text-xs sm:text-sm gap-1.5 font-semibold",
    lg: "px-5 py-2.5 text-xs sm:text-sm gap-2 font-semibold",
    icon: "p-2 text-sm"
  };
